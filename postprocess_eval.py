...
def write_and_evaluate(postprocess_sqls, db_path, table_schema_path, gold_path, dataset):
  ...
  if dataset == 'spider':
    ...
    command = '/home/lily/erx2/anaconda3/envs/sqlgan/bin/python3 eval_scripts/evaluation.py --db {} --table {} --etype match --gold {} --pred {}'.format(db_path,
                                                                                                  table_schema_path,
                                                                                                  gold_path,
    ...
    command = '/home/lily/erx2/anaconda3/envs/sqlgan/bin/python3 eval_scripts/evaluation_sqa.py --db {} --table {} --etype match --gold {} --pred {}'.format(db_path,
                                                                                                      table_schema_path,
                                                                                                      gold_path,
                                                                                                      os.path.abspath(output_file))
